...
# Generated by qmake (2.01a) (Qt 4.5.0) on: Sun May 10 14:32:41 2009
...
LIBS          = $(SUBLIBS) -F/opt/local/libexec/qt4-mac/lib -L/opt/local/libexec/qt4-mac/lib -lGLEW -framework QtOpenGL -L/opt/local/lib -L/opt/local/libexec/qt4-mac/lib -F/opt/local/libexec/qt4-mac/lib -framework OpenGL -framework AGL -framework QtGui -framework Carbon -framework AppKit -lpng -framework QtCore -lz -lm -framework ApplicationServices
AR            = ar cq
RANLIB        = ranlib -s
...
SOURCES       = src/re167/BasicMath.cpp \
		...
		src/re167/FirstPersonCamera.cpp build/moc_GLWidget.cpp \
...
all: Makefile bin/project1.app/Contents/PkgInfo bin/project1.app/Contents/Resources/empty.lproj bin/project1.app/Contents/Info.plist $(TARGET)
...
bin/project1.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) bin/project1.app/Contents/Resources || $(MKDIR) bin/project1.app/Contents/Resources 
	@touch bin/project1.app/Contents/Resources/empty.lproj
