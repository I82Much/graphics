...
# Generated by qmake (2.01a) (Qt 4.4.3) on: Tue Apr 21 13:40:04 2009
...
SOURCES       = src/re167/BasicMath.cpp \
		...
		src/re167/BezierCurve.cpp build/moc_GLWidget.cpp \
...
build/BezierCurve.o: src/re167/BezierCurve.cpp src/re167/BezierCurve.h \
		src/re167/RE167_global.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/BezierCurve.o src/re167/BezierCurve.cpp
